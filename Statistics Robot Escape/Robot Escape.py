...
#this is done by creating a shape for the turtle and then creating a pen to draw the baf around the turtle shape
def draw_bag():
    turtle.shape('turtle')
...
if __name__ == '__main__':
    ...
    parser.add_argument("-f", "--function", choices = fns, help = "One of " + ', '.join(fns.kays()))
